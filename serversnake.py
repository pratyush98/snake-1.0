...
serversocket1.bind(('127.0.0.1',9000))
serversocket1.listen(1)
(clientsocket1, address1) = serversocket1.accept()
serversocket2 = socket()
serversocket2.bind(('127.0.0.1',9001))
serversocket2.listen(1)
(clientsocket2, address2) = serversocket2.accept()
serversocket3 = socket()
serversocket3.bind(('127.0.0.1',9002))
serversocket3.listen(1)
(clientsocket3, address3) = serversocket3.accept()
serversocket4 = socket()
serversocket4.bind(('127.0.0.1',9003))
serversocket4.listen(1)
(clientsocket4, address4) = serversocket4.accept()
'''while(1):
        data = clientsocket.recv(1024)
        print(data)
        data1=raw_input('enter something')
    ...
    if mara1==0:
     ...
     '''if velocityy==0:
      ...
      if (pygame.key.get_pressed()[pygame.K_RIGHT] != 0):
        velocityy = 0
        velocityx = '''
     velocityx=int(clientsocket1.recv(1024))
     velocityy=int(clientsocket2.recv(1024))
     print velocityx
     if ctr>1:
    ...
    if mara2==0:
     ...
     for i in range(1,ctr_,1):
      if(posx_[0]==posx_[i] and posy_[0]==posy_[i]):
           ...
           mara2=1
     #input keyboard comms
     clientsocket3.send(str(velocityx_))
     clientsocket4.send(str(velocityy_))
     if velocityy_==0:
